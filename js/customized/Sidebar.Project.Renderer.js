...
function SidebarProjectRenderer(editor) {
  ...
  editor.ui.physicallyCorrectLightsBoolean = physicallyCorrectLightsBoolean;
  ...
  editor.ui.toneMappingSelect = toneMappingSelect;
  ...
  editor.ui.toneMappingExposure = toneMappingExposure;
  ...
  function createRenderer() {
    ...
    currentRenderer.toneMapping = parseFloat(toneMappingSelect.getValue());
    currentRenderer.toneMappingExposure = toneMappingExposure.getValue();
    window.renderer = currentRenderer;
